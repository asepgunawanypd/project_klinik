  ...
  <div class="modal-body">
    <div class="row">
        ...
        <form id="form" class="form-horizontal form-label-left" enctype="multipart/form-data">
		  ...
		  <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="kabupaten_id">Kabupaten / Kota <span class="required">*</span></label>
            <div class="col-md-6 col-sm-6 col-xs-12">
              <select id="kabupaten_id" required name="kabupaten_id" class="form-control col-md-8 col-xs-12" >
                <option></option>
                 <?php
                   foreach ($dataSelect as $val) {
                     ?>
                     <option value="<?php echo $val->id; ?>">
                       <?php echo $val->kabupaten; ?>
                     </option>
                     <?php
                   }
                 ?>
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" id="kecamatan" name="kecamatan" required="required" autocomplete="off" class="form-control col-md-8 col-xs-12">
            </div>
			</div>  
        </div>
    </div>
