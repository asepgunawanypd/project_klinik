<div class="" role="tabpanel" data-example-id="togglable-tabs">
  <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
    ...
    <li class="active"><a href="<?php echo base_url('Kabupaten'); ?>" id="kab-tab">District / City</a></li>
  ...
  <div id="myTabContent" class="tab-content">
    <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="kab-tab">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>List District / City<small>Management</small></h2>
            ...
            <table id="tableData" class="table table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
              <thead>
                <tr>
                  ...
                  <th style="width: 10%;"><div align="center">ID Province</div></th>
