<div class="" role="tabpanel" data-example-id="togglable-tabs">
  <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
    <li class="active"><a href="<?php echo base_url('Provinsi'); ?>" id="pro-tab">Province</a></li>
    <li class=""><a href="<?php echo base_url('Kabupaten'); ?>" id="kab-tab">District / City</a></li>
    <li class=""><a href="<?php echo base_url('Kecamatan'); ?>" id="kec-tab">Districts</a></li>
  ...
  <div id="myTabContent" class="tab-content">
    <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="pro-tab">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>List Province<small>Management</small></h2>
